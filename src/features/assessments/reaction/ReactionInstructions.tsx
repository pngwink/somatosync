  ...
  return (
    <div className="space-y-5">
      ...
      <div className="border-t border-[var(--color-border)] pt-4">
        <h3 className="mb-2 text-[16px] font-semibold text-[var(--color-text-primary)]">Before you start</h3>
        <ul className="space-y-1.5 text-[16px] leading-relaxed text-[var(--color-text-secondary)]">
      ...
      <div className="grid gap-4 border-t border-[var(--color-border)] pt-4 sm:grid-cols-2">
        ...
        <div className="flex items-start gap-2.5">
          ...
          <p className="text-[16px] text-[var(--color-text-secondary)]">Or respond by selecting the large response area on screen.</p>
        </div>
      ...
      <div className="flex items-center justify-between border-t border-[var(--color-border)] pt-4">
        <p className="text-[16px] text-[var(--color-text-tertiary)]">Estimated time: about 3 minutes</p>

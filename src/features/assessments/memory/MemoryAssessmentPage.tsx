          ...
          {(() => {
            ...
            return tolerance ? (
              <div className="mt-5 rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface-sunken)] p-4">
                ...
                <p className="mt-2 text-[14px] leading-6 text-[var(--color-text-tertiary)]">Performance and symptom cost are shown separately so a higher score is not automatically treated as better tolerance.</p>
              </div>
            ) : null;
          })()}

          <div className="mt-5 rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface-sunken)] p-4">
            <h2 className="text-[14.5px] font-medium text-[var(--color-text-primary)]">What this means</h2>
    ...
    <div className="mx-auto max-w-3xl space-y-5">
        ...
        <Card className="p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              {mode === "demo" && (
                <p className="mt-3 rounded-[var(--radius-sm)] bg-[var(--color-caution-soft)] px-3 py-2 text-[14.5px] text-[var(--color-caution)]">
      ...
      {phase === "preCheck" && (
        <Card className="p-6">
          ...
          <p className="mt-1 text-[15px] leading-6 text-[var(--color-text-secondary)]">This brief check lets SomatoSync track both memory performance and how demanding the task felt.</p>
          <div className="mt-4">
            <TaskToleranceCheck
              mode="pre"
      ...
      {phase === "encoding" && (
        <Card className="flex min-h-[360px] flex-col items-center justify-center p-8 text-center" aria-live="polite">
          <p className="text-[14.5px] font-medium uppercase tracking-[0.16em] text-[var(--color-text-tertiary)]">
          ...
          <p className="mt-5 text-[14px] text-[var(--color-text-secondary)]">Read silently. Do not write the words down.</p>
        </Card>
      )}
      ...
      {phase === "delay" && (
        <Card className="p-7 text-center">
          ...
          <p className="mt-4 text-[14.5px] text-[var(--color-text-tertiary)]">
...
function RecallCard({
  ...
  return (
    <Card className="p-6">
      ...
      <p className="mt-1 text-[14px] text-[var(--color-text-secondary)]">{description}</p>
      <Textarea
        className="mt-4 min-h-36 text-[15px]"
        value={value}

...
export function Wordmark({ className }: { className?: string }) {
  return (
    ...
    >
      <span className="inline-flex h-6 w-6 items-center justify-center rounded-[7px] bg-[var(--color-accent)] font-mono text-[16px] font-bold text-[var(--color-accent-foreground)]">
        s
      </span>
      <span>

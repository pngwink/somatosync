...
export function CardTitle({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return <h3 className={cn("text-[19px] font-semibold tracking-tight text-[var(--color-text-primary)]", className)} {...props} />;
}

export function CardDescription({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) {
  return <p className={cn("text-[15.5px] leading-7 text-[var(--color-text-secondary)]", className)} {...props} />;
}
